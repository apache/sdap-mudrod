 ...
 */
package org.apache.sdap.mudrod.ranking.offline.predict;
 ...
 */
public class OfflineLearner implements Serializable {
  /**
   *
   */
   ...
   */
  public OfflineLearner(SparkDriver skd, String svmSgdModel) {
      sc = skd.sc.sc();
